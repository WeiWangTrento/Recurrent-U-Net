...
def split_data(directory, random_generator, person_ID, lists):
    ...
    id_orders = [52, 53, 54] # random_generator.permutation(51)+1
    n_train, n_val, n_test = 2, 0 ,1 # 30, 10, 11
    id_train, id_val, id_test =  [52, 53], [], [54]# id_orders[0:n_train], id_orders[n_train:(n_train+n_val)], id_orders[(n_train+n_val):51]
    ...
    folder = 'train_val_test_split_ext'
